...
export default function Home() {
  ...
  require("/public/images/code2.jpg"), 
          ...
          {/* <div className={styles.column1} >
           ...
           <div   
              ...
              <div className={styles.backgroundImage_2}>
                  ...
                  Donde empesar a programar
                    </h1>
                  </div>
                     <p><Link href="/viaje/playa" >sigue leyendo ...</Link>  </p>
          </div>
